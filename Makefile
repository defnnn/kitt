...
dc0-gateway:
	. .env; export CONSUL_HTTP_TOKEN; env CONSUL_HTTP_ADDR=169.254.32.10:8500 CONSUL_GRPC_ADDR=169.254.32.10:8502 consul connect envoy -mesh-gateway -register -address 169.254.32.10:4444
